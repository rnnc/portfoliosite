      ...
      {({inView, ref})=>{
        ...
        return (
          <svg className="svgLogos" viewBox="0 0 1001.13 890.65" ref={ref}>
            <circle className={classnames("reactLogo_circle", {"visible":inView})} fill={react_color} cx="504.59" cy="444.48" r="89.57" />
      ...
      {({inView, ref})=>{
        ...
        return (
          <svg className="svgLogos" viewBox="0 0 503 505" ref={ref}>
            <path  className={classnames("apolloLogo_A", {"visible":inView})} fill={apollo_blue} d="M322.9,368.3H385L285.9,111h-68.7l-99.1,257.3h62.1l16.2-43.6h93.7l-17-48.2h-61.7l40.1-110.7L322.9,368.3z"/>
