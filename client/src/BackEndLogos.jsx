      ...
      {({isVisible})=>{
        ...
        return (
          <svg className="logos" viewBox="0 0 36.8 40.8">
            <path className={`nodejsLogo_S ${isVisible? 'nodejsLogo_S_entered': ''}`} fill={nodegreen} d="M23,28.8c-6.4,0-7.8-3-7.8-5.4c0-0.2,0.2-0.4,0.4-0.4h1.9c0.2,0,0.4,0.2,0.4,0.4c0.3,1.9,1.1,2.9,5,2.9
  ...
  return (
    <TrackVisibility partialVisibility>
      {({isVisible})=>{
        ...
        const circleClassname = `graphqlLogo_circle ${isVisible? 'graphqlLogo_circle_entered':''}`;
