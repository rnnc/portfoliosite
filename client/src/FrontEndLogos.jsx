...
export const ReactLogo = ({ isVisible }) => {
  ...
  return (
    <TrackVisibility partialVisibility>
      {({isVisible})=>{
        ...
        return (
          <svg className="logos" viewBox="0 0 1001.13 890.65">
            <circle className={classnames("reactLogo_circle", {reactLogo_circle_entered: isVisible})} 
                    fill={react_color} cx="504.59" cy="444.48" r="89.57" />
  ...
  return(
    <TrackVisibility partialVisibility>
      {({isVisible})=>{
        ...
        const circleClassname = classnames("reduxLogo_circle", {reduxLogo_circle_entered:isVisible});
        
        return (
          <svg className="logos" x="0px" y="0px" viewBox="0 0 83 76.8">
  ...
  return (
    <TrackVisibility partialVisibility>
      {({isVisible})=>{
        ...
        return (
          <svg className="logos" viewBox="0 0 503 505">
            <path  className={`apolloLogo_A ${isVisible? 'apolloLogo_A_entered':''}`} fill={apollo_blue} d="M322.9,368.3H385L285.9,111h-68.7l-99.1,257.3h62.1l16.2-43.6h93.7l-17-48.2h-61.7l40.1-110.7L322.9,368.3z"/>
            <path className={`apolloLogo_circle ${isVisible?'apolloLogo_circle_entered':''}`} 
            ...
            <path className="apolloLogo_path" style={pathStyle} d="M473.8,179.6c26.8,76.8,12.1,161.6-38.9,223.9c-80.9,98.9-230.1,112.6-330.5,30.5s-116.3-231.1-35.4-330
