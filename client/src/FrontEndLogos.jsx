      ...
      {({isVisible})=>{
        ...
        return (
          <svg className="logos" viewBox="0 0 1001.13 890.65">
            <circle className={`reactLogo_circle ${isVisible ? 'reactLogo_circle_entered' : ''}`} fill={react_color} cx="504.59" cy="444.48" r="89.57" />
  ...
  return(
    <TrackVisibility partialVisibility>
      {({isVisible})=>{
        ...
        const circleClassname = `reduxLogo_circle ${isVisible ? 'reduxLogo_circle_entered':''}`;
